                ...
                <div id="reassign">
                    ...
                    <div id="fuzzSearch">
                        ...
                        <div id="fuzzDropdownContainer">
                            <input class="fuzzMagicBox" placeholder="search.."
                            type="text" value=""> <span class=
                            "fuzzSearchIcon"></span>
                        ...
                        <div id="new_target">
                            ...
                            <div id="fuzzSearchTarget">
                                ...
                                <div id="fuzzDropdownContainer">
                                    <input class="fuzzMagicBox" placeholder=
                                    "search.." type="text" value="">
                                    <span class="fuzzSearchIcon"></span>
                                    <ul id="fuzzResults"></ul><button class=
                                    "btn btn-info" id="new_group_button" type=
                                    "button">Create New Group</button>
                                </div>
                            </div>
                        </div>
                        <div id="new_entry"></div><br>
                        <button class="btn btn-success" id="change" type=
                        "button">Confirm</button> <?php include "footer.htm";?>
                    </div>
                </div>
            </div>
        </div>
